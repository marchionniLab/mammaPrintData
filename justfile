...
package_name := 'mammaPrintData'

github_org := 'marchionniLab'
...
@push-bioconductor-git:
  #!/usr/bin/env bash
  \builtin set -euo pipefail;
  git remote set-url --push bioconductor git@git.bioconductor.org:packages/mammaPrintData;
